...
functions = [
    {
        ...
        "parameters": {
            ...
            "properties": {
                "category_name": {
                    "type": "string",
                    "description": "カテゴリ名（例: バスケットボール⛹️‍♀️、typing⛹️‍♀️）"
                }
            },
...
CATEGORY_IDS = {
    ...
    "typing⛹️‍♀️": "6803cf37bd1ca27affcb0089"
}
...
def openai_api(content: str) -> str:
    """
    OpenAI function calling を使ってカテゴリ名からランキングを取得。
    """
    chat_response = client.chat.completions.create(
        ...
        messages=[
            {
                "role": "system",
                "content": "あなたはスポーツやスキルカテゴリのランキングを取得するアシスタントです。"
            },
            {
                "role": "user",
                "content": content
